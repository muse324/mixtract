...
public class MixtractCommand extends MuseAppCommand {
	...
	// "Edit group", "グループを編集");
	// protected static final MixtractCommand SELECT_GROUP = new
	// SelectGroupCommand(
	// "Select group", "グループを選択");
	//
	// public static final MixtractCommand SET_CHORD = new SetChordCommand(
	// "Set Chord", "和音を付与");
	// public static final MixtractCommand ANALYZE_STRUCTURE = new
	// AnalyzeStructureCommand(
	// "Analyze structure", "構造分析");
	//
	// public static final MixtractCommand APPLY_PULSES_CHOPINS = new
	// ApplyPulseChopinsCommand(
	// "Apply pulses (chopin)");
	//
	// public static final MixtractCommand APPLY_PULSES_MOZARTS = new
	// ApplyPuliseMozartsCommand(
	// "Apply pulses (mozart)");
	//
	// public static final MixtractCommand APPLY_TOPONOTE = new
	// ApplyTopNoteCommand(
	// "Apply the most similar expression");
	//
	// public static final MixtractCommand CLEAR_ALLGROUPS = new
	// ClearAllGroupsCommand(
	// "Clear all groups", "フレーズ構造全体を削除");
	//
	// public static final MixtractCommand DELETE_GROUP = new
	// DeleteGroupCommand(
	// "Delete", "グループを削除");
	//
	// public static final MixtractCommand EXPR_LINE_DISPLAY = new
	// ExprLineCommand(
	// "Show/hide expression line");
	//
	// public static final MixtractCommand EXPR_VIEW_DISPLAY = new
	// ExprViewCommand(
	// "Switch expression view");
	// public static final MixtractCommand CHANGE_PART = new ChangePartCommand(
	// "Change part");
	//
	// public static final MixtractCommand MOUSE_DISPLAY = new
	// MouseDisplayCommand(
	// "Show/Hide mouse pointer", "マウスポインタを表示/非表示");
	//
	// public static final MixtractCommand OPEN_RULEPANEL = new
	// OpenRulePanelCommand(
	// "Open rulepanel", "ルールパネル");
	//
	// public static final MixtractCommand OPEN_RULEMAP = new
	// OpenRuleMapCommand(
	// "Open Rulemap", "ルールマップを開く");
	// public static final MixtractCommand PRINT_ALLGROUPS = new
	// PrintAllGroupsCommand(
	// "Print all groups", "全グループを出力");
	//
	// public static final MixtractCommand PRINT_ALL_SIMILAR_GROUPS = new
	// PrintAllSimilarGroupsCommand(
	// "Show all similar groups", "Show all similar groups");
	//
	// public static final MixtractCommand PRINT_SIMILAR_GROUPS = new
	// PrintSimilarGroupsCommand(
	// "Show similar groups");
	//
	// public static final MixtractCommand PRINT_SUBGROUPS = new
	// PrintSubgroupsCommand(
	// "Print group", "下位グループを出力");
	//
	// public static final MixtractCommand APPLY_HIERARCHICAL_PARAMS = new
	// ApplyHierarchicalParamsCommand(
	// "Apply Parametrs", "階層表現に適用");
	//
	// public static final MixtractCommand RESET_PRAMETERS = new
	// ResetParameterCommand(
	// "Reset parameters");
	// public static final MixtractCommand SHOW_SIMILAR_GROUPS = new
	// ShowSimilarGroupsCommand(
	// "Show similar groups");
	//
	// public static final MixtractCommand SEARCH = new SearchCommand("Search",
	// "検索");
	//
	// public static final MixtractCommand ANALYZE_GTTM_STRUCTURE = new
	// GTTMAnalysisCommand(
	// "GTTMAnalysis");
	// public static final MixtractCommand MAKE_GROUP = new MakeGroupCommand(
	// "Make a group", "グループを作成");
	//
	// public static final MixtractCommand OPEN_STRUCTURE_DATA = new
	// OpenStructureDataCommand(
	...
	// public static final MixtractCommand SET_TYPE_CRESC = new
	// SetCrescendoCommand(
	// "< (cresc.)");
	// public static final MixtractCommand SET_TYPE_DIM = new
	// SetDiminuendoCommand(
	// "> (dim.)");
	// public static final MixtractCommand PRINT_GROUP_INFO = new
	// PrintGroupInfoCommand(
	...
	public static MuseAppCommand create(String cmd) {
		MuseAppCommandType type1 = MuseAppCommandType.valueOf(cmd);
		if (type1 != null)
			return type1.self();
		MixtractCommandType type2 = MixtractCommandType.valueOf(cmd);
		return type2.self();
	}
