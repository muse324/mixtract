...
public class PEDBTopNoteLabel extends PEDBNoteLabel {
	...
	public void paint(Graphics g){
	    ...
	    //RoundRectangle2D rect = new RoundRectangle2D.Double(30, 50, 100, 100, 30, 10);
	...
	public PEDBTopNoteLabel(NoteData topNote, RoundRectangle2D topr) {
		...
		super(topNote, new Rectangle((int)topr.getX(),(int)topr.getY(),(int)topr.getWidth(),(int)topr.getHeight()));
		d = topr;
